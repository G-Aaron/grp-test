 ...
 * @version 1.0
 * @author: gaorenpeng
 * @date: 2019-01-29 13:46
 **/
public class StringCompiler {
    private static WeakReference<StringCompiler> mWeakReference = new WeakReference<>(new StringCompiler());

    public static Object eval() {
        StringCompiler eval = mWeakReference.get();
        String method = "main";
    ...
    private Object run(String method,String codes){
        String className = "com.grp.test.Eval";
        StringBuilder sb = new StringBuilder();
        sb.append("package com.grp.test;");
        sb.append("\n public class Eval{\n ");
        sb.append(codes);
        sb.append("\n}");
