...
public class TopTen {
	...
	public static void main(String[] args) {
		try {
			...
			options.addOption("h", "host", true, "Server hostname (default: 192.168.1.216)");
			...
			CommandLine cl = parser.parse(options, new String[]{"-q"}, false);
			// CommandLine cl = parser.parse(options, args, false);

			String host = cl.getOptionValue("h", "192.168.1.216");
